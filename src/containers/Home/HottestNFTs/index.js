            ...
            <div className="container mx-auto">
                <div className="mb-8 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center">
                        <button className="w-6 h-6 flex items-center justify-center mx-2 bg-dark-gray rounded-full text-white text-opacity-50" onClick={sliderPrev}><MdKeyboardArrowLeft size={16} /></button>
                        <button className="w-6 h-6 flex items-center justify-center mx-2 bg-dark-gray rounded-full text-white text-opacity-50" onClick={sliderNext}><MdKeyboardArrowRight size={16} /></button>
                    </div>
                </div>
